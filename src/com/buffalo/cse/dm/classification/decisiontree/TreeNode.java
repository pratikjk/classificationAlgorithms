...
public abstract class TreeNode {
    /**
     * An enumerator for classifying the structural type of a tree node - Leaf
     * nodes represents the ClassLabel and indication that no other descision is
     * needed. - Binary nodes represents a split into two possible values. -
